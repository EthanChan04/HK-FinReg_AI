...
> **收尾复跑：** 2026-08-07 在 17 份重建文档、60 个案例上复跑；固定/自适应 chunk 数 632/783，指标与本报告一致。
...
1. **自适应分块呈现正向聚合信号**：claim_recall +8.3pp，6 胜、1 负、53 平，context_precision +1.1pp；大量平局说明证据尚不足以称为“稳定优于”。
2. **尚未满足计划的 A/B 决策条件**：仍需按 task_type 分层验证“至少 2 个任务类型稳定优于固定分块”。
